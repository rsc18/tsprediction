...
if __name__ == '__main__':
    ...
    if arguments['--listcompanies']==True:
        ...
        train_test_data_tuple=dataloader_from_pandas(dataset,train=True,sequence_length=sequence_length)
        train_data_tuple=(train_test_data_tuple[0],train_test_data_tuple[1])
        model,loss=train_model(train_data_tuple,sequence_length,save_model=save_model) 
        ...
        train_test_data_tuple=dataloader_from_pandas(dataset_train,train=True,sequence_length=sequence_length,train_size_percentage=1)
        train_data_tuple=(train_test_data_tuple[0],train_test_data_tuple[1])
        model,loss=train_model(train_data_tuple,sequence_length,save_model=save_model) 
        print(f'loss of trained model = {loss}')
     
        # test_data_tuple=(train_test_data_tuple[2],train_test_data_tuple[3])
        train_test_data_tuple=dataloader_from_pandas(dataset_test,train=True,sequence_length=sequence_length,train_size_percentage=0)
        test_data_tuple=(train_test_data_tuple[2],train_test_data_tuple[3])
